...
//		ArrayList<? super Son> list2 = new ArrayList<? super Son>();
...
//		xyz(list2);
	...
	public void qwe(ArrayList<?> list) {
		// ? 는 모든 것을 의미해서 Object 를 제너릭스로 선언한 것이 된다.
	}
	
	public void abc(ArrayList<? super Son> list) {
		// 이 함수의 매개변수는 Son, Father, Grand, Object 타입의 데이터를 입력해서 만든 리스트를 호출할 수 있다.
 	}

	public void xyz(ArrayList<? extends Son> list) {
		// 이 함수를 호출 할 때 입력하는 리스트는 Son 의 객체들을 입력한 리스트거나
		// GrandSon 의 객체들을 입력한 리스트여야만 한다.
	}
