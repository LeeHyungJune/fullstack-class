...
public class EmpView {
	...
	public void empInfoPrint(Scanner sc) {
//		ArrayList empnoList = empnoList();
		System.out.print("사원번호 입력 : ");
		int no = sc.nextInt();
		System.out.println();
		
		ArrayList<EmpVO> list = eDao.getEmpInfo(no);
		
		System.out.println("*** " + no + " 정보조회");
		System.out.println("===========================================================================");
		System.out.println("| 사원번호 |  사원이름  |   직  급   |        입   사   일       | 급  여 |");
		System.out.println("---------------------------------------------------------------------------");
		for(EmpVO evo : list) {
			System.out.printf("|%7d   | %10s | %10s | %22s | %6d |\n", 
					evo.getEno(), evo.getEname(), evo.getJob(), 
					evo.getSdate(), evo.getSal());
		}
		System.out.println("============================================================================");
		System.out.println();
	}
