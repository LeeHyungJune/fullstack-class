...
/*
 	...
 	어제까지의 작업 내용을 보면 반복적인 작업이 많이 포함되어있다.
			...
			/*
			 	양방향 이동가능한 Statement 만들기
			 		...
			 		ResultSet 의 Type
			 			...
			 			2.	TYPE_SCROLL_INSENSITIVE		:	scroll 이 가능하나, 변경된 사항은 적용되지 않음
			 			3.	TYPE_SCROLL_SENSITIVE		:	scroll 도 가능하고 변경된 사항도 적용
			 		
			 		CONCURRENCY 의 TYPE
			 			1.	CONCUR_READ_ONLY	:	ResultSet 객체의 변경이 불가능
			 			2.	CONCUR_UPDATEABLE	:	ResultSet 객체의 변경이 가능
