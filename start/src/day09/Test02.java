...
/*
 	두 수를 이용해서 더하는 프로그램을 작성하시오.
 	
 	단, 입력, 계산, 출력을 함수로 만들어서 처리하시오.
...
//		abc();
	...
	public int cal(int no1, int no2) {
		...
		// 반환값 내보내고...
		return result;	
		// 1. 실행중인 이 함수를 즉시 종료한다.	
		// 2. 결과값이 있으면 결과값을 내보내고 함수를 종료한다.
	}
	...
	public  void toPrint(int no1, int no2) {
		...
		return; // 이 명령을 기술하지 않아도 실행내용을 모두 실행했으므로 이 함수가 자동 종료 된다.
	}
