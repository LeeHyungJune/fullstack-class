...
//		System.out.println("1년은 " + 365 + "일 " + 5 + "시간 " + 49 + "분 " + 20 + "초 입니다.");
		...
		sec = (int)((((((year - day) * 24) - hour) * 60) - min) * 60); // ((전체(실수) - 일(정수) - 시간(정수) - 분(정수)) * 60 해서 초 단위로 변형

		System.out.println("1년은 " + day + "일 " + hour + "시간 " + min + "분 " + sec + "초 입니다."); // 결과 출력
		
//		double total = 20960.64; // 349.344, 5.8224
//		int tmp = (int)total;
//		int min = tmp / 60;
//		tmp %= 60;
...
//		int hour = (int)(0.2426 * 24);
//		System.out.println(hour);
//		int min = (int)(((0.2426 * 24) - hour) * 60);
//		System.out.println
//		
	}
}
