...
public class Test01 {
	...
	public Test01() {
		...
		// 결로가 잘못되면 파일을 만들 수 없으므로 예외처리가 필요하다.
		try {
			fout = new FileOutputStream("C:\\class\\repo\\fullstack-class\\start\\src\\day17\\result\\FileTest01.txt");
